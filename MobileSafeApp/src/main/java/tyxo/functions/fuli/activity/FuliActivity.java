...
import tyxo.functions.fuli.Fragment.PageFragment;
...
public class FuliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fuli_activity_main);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_about) {
            Intent intent = new Intent(FuliActivity.this,AboutActivity.class);
