package tyxo.functions.smoothpic;
...
public class CardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.smooth_card_layout, null);
        initView(rootView);
        return rootView;
    }
    ...
    private void initView(View rootView) {
        ...
        cardSwitchListener = new CardSlidePanel.CardSwitchListener() {
            ...
            public void onCardVanish(int index, int type) {
                ...
                if (type == 0) {
                    ToastUtil.showToastS(getActivity(),dataList.get(index).userName+"被添加到免打扰");
                } else {
                    ToastUtil.showToastS(getActivity(),dataList.get(index).userName+"被添加到收藏");
                }
            }
            ...
            public void onItemClick(View cardView, int index) {
                ...
                ToastUtil.showToastS(getActivity(),dataList.get(index).userName+"点击了");
            }
        };
