...
import tyxo.functions.prettygirls.util.BitmapUtil;
 ...
 */
public class FragmentGirl extends BaseFragment implements ViewPager.OnPageChangeListener {

    private ViewPager mViewPager;
    private LinearLayout mRootView;
    private AdapterGirl mAdapter;
    private ArrayList<BeanGirls.ShowapiResBodyBean.NewslistBean> datas;
    private int current;
    ...
    public static FragmentGirl newInstance(ArrayList<Parcelable> datas, int current) {
        Bundle bundle = new Bundle();
        FragmentGirl fragment = new FragmentGirl();
        bundle.putParcelableArrayList("girls", datas);
        HLog.v("tyxo","FragmentGirl datas 1size : "+datas);
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            datas = (ArrayList<BeanGirls.ShowapiResBodyBean.NewslistBean>) bundle.getSerializable("girls");
            current = bundle.getInt("current");
        }

        mAdapter = new AdapterGirl(mActivity, datas);
        HLog.v("tyxo","FragmentGirl datas size : "+datas);
