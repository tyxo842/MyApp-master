...
/**
* @author ly
* @des : 可以一键清除内容的 EditText
*/
public class AutoClearEditText extends AutoCompleteTextView implements OnFocusChangeListener, TextWatcher {
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			mClearDrawable = getResources().getDrawable(R.drawable.auto_clear_selector);
		}
