...
import tyxo.mobilesafe.db.annotation.Check;
import tyxo.mobilesafe.db.annotation.NotNull;
import tyxo.mobilesafe.db.annotation.Transient;
import tyxo.mobilesafe.db.annotation.Unique;
import tyxo.mobilesafe.db.annotation.Column;
import tyxo.mobilesafe.db.annotation.Id;
import tyxo.mobilesafe.db.annotation.Finder;
import tyxo.mobilesafe.db.annotation.Foreign;
...
public class ColumnUtils {
    ...
    public static Method getColumnGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                HLog.e(ColumnUtils.class.getSimpleName(), methodName + " not exist");
            }
        }
    ...
    public static Class<?> getForeignEntityType(tyxo.mobilesafe.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(tyxo.mobilesafe.db.table.Finder finderColumn) {
