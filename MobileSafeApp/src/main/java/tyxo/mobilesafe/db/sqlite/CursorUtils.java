...
public class CursorUtils {
    ...
    public static <T> T getEntity(final HDbManager db, final Cursor cursor, Class<T> entityType, long findCacheSequence) {
        ...
        try {
        	...
        	HLog.e(CursorUtils.class.getSimpleName(), e.getMessage());
        }
